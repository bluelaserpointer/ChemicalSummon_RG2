...
public class TransportCard : GamerAction
{
    [SerializeField]
    bool isCopy;
    [SerializeField]
    ...
    {
        string baseString = General.LoadSentence("CardTransport");
        baseString = baseString.Replace("$action", General.LoadSentence(isCopy ? "Copy" : "Move"));
